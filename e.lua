getgenv().Config = {
        ...
        PetFarm = {
            ...
            EggType = "retired_egg", -- Which egg to equip ("any" = first available, or specific egg ID)
            BuyEggType = "any", -- Which egg to buy when BuyEggs is true ("any" or specific egg ID)
            MaxPets = 2, -- How many pets to equip at once (1 = free, 2 = requires Robux gamepass)
        ...
        EventFarm = {
            ...
            AutoSleighball = false, -- Automatically play sleighball minigame (does not work with baby or pet farm)
            AutoHumbug = false, -- Automatically play humbug minigame (does not work with baby or pet farm)
            AutoStarCatch = false, -- Automatically play star catch minigame (does not work with baby or pet farm)
        },
        AutoTrade = {
        ...
        Webhook = {
            ...
            PetUnlock = {
                ...
                URL = "https://discord.com/api/webhooks/1416373985012355104/35Rs2-I_VtuyA8gVkPDBQFuQVWYbQYCWwjnAg5WEwFa3a0P47_PzvcazyUd-3ZpoaV2-", -- Webhook URL for pet unlocks
